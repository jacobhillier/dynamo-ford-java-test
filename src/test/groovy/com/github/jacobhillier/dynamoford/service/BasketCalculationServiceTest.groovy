...
class BasketCalculationServiceTest extends Specification {
    ...
    void "should calculate basket value with matching discounts"() {
        given:
        Discount basketItem1Discount = new Discount(basketItem1.productName, 0.1, null)
        Discount basketItem2Discount = new Discount(basketItem2.productName, 0.2, null)
    ...
    void "should calculate basket value with matching discount and required basket item"() {
        ...
        Discount basketItem2Discount = new Discount(basketItem2.productName, 0.1, requiredBasketItem)
    ...
    void "should calculate basket value with matching discount and required basket item not met"() {
        given:
        RequiredBasketItem requiredBasketItem = new RequiredBasketItem(basketItem1.productName, 2)
        Discount basketItem2Discount = new Discount(basketItem2.productName, 0.1, requiredBasketItem)
